...
namespace Pulumi.Ovh
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Ovh.version.txt");
    ...
    internal sealed class OvhResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public OvhResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
