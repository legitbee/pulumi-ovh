...
{
    [OvhResourceType("ovh:index/ovh_dbaas_logs_input:ovh_dbaas_logs_input")]
    public partial class Ovh_dbaas_logs_input : Pulumi.CustomResource
    {
        /// <summary>
        /// IP blocks
        /// </summary>
        ...
        public Output<Outputs.Ovh_dbaas_logs_inputConfiguration> Configuration { get; private set; } = null!;
        ...
        public Ovh_dbaas_logs_input(string name, Ovh_dbaas_logs_inputArgs args, CustomResourceOptions? options = null)
            : base("ovh:index/ovh_dbaas_logs_input:ovh_dbaas_logs_input", name, args ?? new Ovh_dbaas_logs_inputArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ovh_dbaas_logs_input(string name, Input<string> id, Ovh_dbaas_logs_inputState? state = null, CustomResourceOptions? options = null)
            : base("ovh:index/ovh_dbaas_logs_input:ovh_dbaas_logs_input", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Ovh_dbaas_logs_input Get(string name, Input<string> id, Ovh_dbaas_logs_inputState? state = null, CustomResourceOptions? options = null)
        {
            return new Ovh_dbaas_logs_input(name, id, state, options);
        }
    }

    public sealed class Ovh_dbaas_logs_inputArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.Ovh_dbaas_logs_inputConfigurationArgs> Configuration { get; set; } = null!;
        ...
        public Ovh_dbaas_logs_inputArgs()
        {
        }
    }

    public sealed class Ovh_dbaas_logs_inputState : Pulumi.ResourceArgs
    {
        [Input("allowedNetworks")]
        private InputList<string>? _allowedNetworks;
        ...
        /// </summary>
        [Input("configuration")]
        public Input<Inputs.Ovh_dbaas_logs_inputConfigurationGetArgs>? Configuration { get; set; }
        ...
        public Ovh_dbaas_logs_inputState()
        {
        }
    }
}
