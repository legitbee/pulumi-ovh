...
{
    [OvhResourceType("ovh:index/dbaasLogsInput:DbaasLogsInput")]
    public partial class DbaasLogsInput : Pulumi.CustomResource
    {
        /// <summary>
        /// IP blocks
        /// </summary>
        ...
        public Output<Outputs.DbaasLogsInputConfiguration> Configuration { get; private set; } = null!;
        ...
        public DbaasLogsInput(string name, DbaasLogsInputArgs args, CustomResourceOptions? options = null)
            : base("ovh:index/dbaasLogsInput:DbaasLogsInput", name, args ?? new DbaasLogsInputArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DbaasLogsInput(string name, Input<string> id, DbaasLogsInputState? state = null, CustomResourceOptions? options = null)
            : base("ovh:index/dbaasLogsInput:DbaasLogsInput", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DbaasLogsInput Get(string name, Input<string> id, DbaasLogsInputState? state = null, CustomResourceOptions? options = null)
        {
            return new DbaasLogsInput(name, id, state, options);
        }
    }

    public sealed class DbaasLogsInputArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DbaasLogsInputConfigurationArgs> Configuration { get; set; } = null!;
        ...
        public DbaasLogsInputArgs()
        {
        }
    }

    public sealed class DbaasLogsInputState : Pulumi.ResourceArgs
    {
        [Input("allowedNetworks")]
        private InputList<string>? _allowedNetworks;
        ...
        /// </summary>
        [Input("configuration")]
        public Input<Inputs.DbaasLogsInputConfigurationGetArgs>? Configuration { get; set; }
