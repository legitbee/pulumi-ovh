...
{
    [OvhResourceType("ovh:index/ovh_dbaas_logs_output_graylog_stream:ovh_dbaas_logs_output_graylog_stream")]
    public partial class Ovh_dbaas_logs_output_graylog_stream : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Ovh_dbaas_logs_output_graylog_stream(string name, Ovh_dbaas_logs_output_graylog_streamArgs args, CustomResourceOptions? options = null)
            : base("ovh:index/ovh_dbaas_logs_output_graylog_stream:ovh_dbaas_logs_output_graylog_stream", name, args ?? new Ovh_dbaas_logs_output_graylog_streamArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ovh_dbaas_logs_output_graylog_stream(string name, Input<string> id, Ovh_dbaas_logs_output_graylog_streamState? state = null, CustomResourceOptions? options = null)
            : base("ovh:index/ovh_dbaas_logs_output_graylog_stream:ovh_dbaas_logs_output_graylog_stream", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Ovh_dbaas_logs_output_graylog_stream Get(string name, Input<string> id, Ovh_dbaas_logs_output_graylog_streamState? state = null, CustomResourceOptions? options = null)
        {
            return new Ovh_dbaas_logs_output_graylog_stream(name, id, state, options);
        }
    }

    public sealed class Ovh_dbaas_logs_output_graylog_streamArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Cold storage compression method
        /// </summary>
        ...
        public Ovh_dbaas_logs_output_graylog_streamArgs()
        {
        }
    }

    public sealed class Ovh_dbaas_logs_output_graylog_streamState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Indicates if the current user can create alert on the stream
        /// </summary>
        ...
        public Ovh_dbaas_logs_output_graylog_streamState()
        {
        }
    }
}
