...
{
    [OvhResourceType("ovh:index/meInstallationTemplate:MeInstallationTemplate")]
    public partial class MeInstallationTemplate : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<Outputs.MeInstallationTemplateCustomization?> Customization { get; private set; } = null!;
        ...
        public MeInstallationTemplate(string name, MeInstallationTemplateArgs args, CustomResourceOptions? options = null)
            : base("ovh:index/meInstallationTemplate:MeInstallationTemplate", name, args ?? new MeInstallationTemplateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MeInstallationTemplate(string name, Input<string> id, MeInstallationTemplateState? state = null, CustomResourceOptions? options = null)
            : base("ovh:index/meInstallationTemplate:MeInstallationTemplate", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MeInstallationTemplate Get(string name, Input<string> id, MeInstallationTemplateState? state = null, CustomResourceOptions? options = null)
        {
            return new MeInstallationTemplate(name, id, state, options);
        }
    }

    public sealed class MeInstallationTemplateArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// OVH template name yours will be based on, choose one among the list given by compatibleTemplates function
        /// </summary>
        ...
        [Input("customization")]
        public Input<Inputs.MeInstallationTemplateCustomizationArgs>? Customization { get; set; }
        ...
        public MeInstallationTemplateArgs()
        {
        }
    }

    public sealed class MeInstallationTemplateState : Pulumi.ResourceArgs
    {
        ...
        [Input("customization")]
        public Input<Inputs.MeInstallationTemplateCustomizationGetArgs>? Customization { get; set; }
        ...
        public MeInstallationTemplateState()
        {
        }
    }
}
