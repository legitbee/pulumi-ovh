...
namespace Pulumi.Ovh
{
    ...
    public partial class CloudProject : Pulumi.CustomResource
    {
        [Output("access")]
    ...
    public sealed class CloudProjectArgs : Pulumi.ResourceArgs
    {
        [Input("description")]
    ...
    public sealed class CloudProjectState : Pulumi.ResourceArgs
    {
        [Input("access")]
