...
namespace Pulumi.Ovh.Outputs
{
    ...
    [OutputType]
    public sealed class GetOvh_Order_Cart_ProductResultPriceResult
    {
        ...
        public readonly ImmutableArray<Outputs.GetOvh_Order_Cart_ProductResultPricePriceResult> Prices;
        public readonly string PricingMode;
        public readonly string PricingType;

        [OutputConstructor]
        private GetOvh_Order_Cart_ProductResultPriceResult(
            ...
            ImmutableArray<Outputs.GetOvh_Order_Cart_ProductResultPricePriceResult> prices,
