...
namespace Pulumi.Ovh.Outputs
{
    ...
    [OutputType]
    public sealed class GetOvh_Order_Cart_Product_PlanPriceResult
    {
        ...
        public readonly ImmutableArray<Outputs.GetOvh_Order_Cart_Product_PlanPricePriceResult> Prices;
        public readonly string PricingMode;
        public readonly string PricingType;

        [OutputConstructor]
        private GetOvh_Order_Cart_Product_PlanPriceResult(
            ...
            ImmutableArray<Outputs.GetOvh_Order_Cart_Product_PlanPricePriceResult> prices,
