...
namespace Pulumi.Ovh.Outputs
{
    ...
    [OutputType]
    public sealed class GetOvh_Order_Cart_Product_Options_PlanSelectedPriceResult
    {
        ...
        public readonly ImmutableArray<Outputs.GetOvh_Order_Cart_Product_Options_PlanSelectedPricePriceResult> Prices;
        public readonly string PricingMode;
        public readonly string PricingType;

        [OutputConstructor]
        private GetOvh_Order_Cart_Product_Options_PlanSelectedPriceResult(
            ...
            ImmutableArray<Outputs.GetOvh_Order_Cart_Product_Options_PlanSelectedPricePriceResult> prices,
