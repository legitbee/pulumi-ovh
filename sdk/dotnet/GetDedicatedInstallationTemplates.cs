...
namespace Pulumi.Ovh
{
    public static class GetDedicatedInstallationTemplates
    {
        public static Task<GetDedicatedInstallationTemplatesResult> InvokeAsync(InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetDedicatedInstallationTemplatesResult>("ovh:index/getDedicatedInstallationTemplates:getDedicatedInstallationTemplates", InvokeArgs.Empty, options.WithVersion());
    }
