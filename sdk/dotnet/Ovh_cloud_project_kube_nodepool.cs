...
{
    [OvhResourceType("ovh:index/ovh_cloud_project_kube_nodepool:ovh_cloud_project_kube_nodepool")]
    public partial class Ovh_cloud_project_kube_nodepool : Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Ovh_cloud_project_kube_nodepool(string name, Ovh_cloud_project_kube_nodepoolArgs args, CustomResourceOptions? options = null)
            : base("ovh:index/ovh_cloud_project_kube_nodepool:ovh_cloud_project_kube_nodepool", name, args ?? new Ovh_cloud_project_kube_nodepoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ovh_cloud_project_kube_nodepool(string name, Input<string> id, Ovh_cloud_project_kube_nodepoolState? state = null, CustomResourceOptions? options = null)
            : base("ovh:index/ovh_cloud_project_kube_nodepool:ovh_cloud_project_kube_nodepool", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Ovh_cloud_project_kube_nodepool Get(string name, Input<string> id, Ovh_cloud_project_kube_nodepoolState? state = null, CustomResourceOptions? options = null)
        {
            return new Ovh_cloud_project_kube_nodepool(name, id, state, options);
        }
    }

    public sealed class Ovh_cloud_project_kube_nodepoolArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable anti affinity groups for nodes in the pool
        /// </summary>
        ...
        public Ovh_cloud_project_kube_nodepoolArgs()
        {
        }
    }

    public sealed class Ovh_cloud_project_kube_nodepoolState : Pulumi.ResourceArgs
    {
        /// <summary>
        /// Enable anti affinity groups for nodes in the pool
        /// </summary>
        ...
        public Ovh_cloud_project_kube_nodepoolState()
        {
        }
    }
}
