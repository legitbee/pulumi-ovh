...
namespace Pulumi.Ovh
{
    public static class GetMeInstallationTemplate
    {
        public static Task<GetMeInstallationTemplateResult> InvokeAsync(GetMeInstallationTemplateArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMeInstallationTemplateResult>("ovh:index/getMeInstallationTemplate:getMeInstallationTemplate", args ?? new GetMeInstallationTemplateArgs(), options.WithVersion());
    }


    public sealed class GetMeInstallationTemplateArgs : Pulumi.InvokeArgs
    {
