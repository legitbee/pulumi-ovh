...
__all__ = ['Ovh_dedicated_server_updateArgs', 'Ovh_dedicated_server_update']

@pulumi.input_type
class Ovh_dedicated_server_updateArgs:
...
@pulumi.input_type
class _Ovh_dedicated_server_updateState:
    def __init__(__self__, *,
                 boot_id: Optional[pulumi.Input[int]] = None,
                 monitoring: Optional[pulumi.Input[bool]] = None,
...
class Ovh_dedicated_server_update(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a Ovh_dedicated_server_update resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Ovh_dedicated_server_updateArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a Ovh_dedicated_server_update resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param Ovh_dedicated_server_updateArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Ovh_dedicated_server_updateArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = Ovh_dedicated_server_updateArgs.__new__(Ovh_dedicated_server_updateArgs)
        ...
        super(Ovh_dedicated_server_update, __self__).__init__(
            'ovh:index/ovh_dedicated_server_update:ovh_dedicated_server_update',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            monitoring: Optional[pulumi.Input[bool]] = None,
            service_name: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None) -> 'Ovh_dedicated_server_update':
        """
        ...
        __props__ = _Ovh_dedicated_server_updateState.__new__(_Ovh_dedicated_server_updateState)

        __props__.__dict__["boot_id"] = boot_id
        __props__.__dict__["monitoring"] = monitoring
        __props__.__dict__["service_name"] = service_name
        __props__.__dict__["state"] = state
        return Ovh_dedicated_server_update(resource_name, opts=opts, __props__=__props__)
