...
__all__ = [
    'GetOvh_Me_Paymentmean_CreditcardResult',
    'AwaitableGetOvh_Me_Paymentmean_CreditcardResult',
    'get_ovh__me__paymentmean__creditcard',
    'get_ovh__me__paymentmean__creditcard_output',
]

@pulumi.output_type
class GetOvh_Me_Paymentmean_CreditcardResult:
    """
...
class AwaitableGetOvh_Me_Paymentmean_CreditcardResult(GetOvh_Me_Paymentmean_CreditcardResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOvh_Me_Paymentmean_CreditcardResult(
...
def get_ovh__me__paymentmean__creditcard(description_regexp: Optional[str] = None,
                                         states: Optional[Sequence[str]] = None,
                                         use_default: Optional[bool] = None,
                                         use_last_to_expire: Optional[bool] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOvh_Me_Paymentmean_CreditcardResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ovh:index/getOvh_Me_Paymentmean_Creditcard:getOvh_Me_Paymentmean_Creditcard', __args__, opts=opts, typ=GetOvh_Me_Paymentmean_CreditcardResult).value

    return AwaitableGetOvh_Me_Paymentmean_CreditcardResult(
...
@_utilities.lift_output_func(get_ovh__me__paymentmean__creditcard)
def get_ovh__me__paymentmean__creditcard_output(description_regexp: Optional[pulumi.Input[Optional[str]]] = None,
                                                ...
                                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOvh_Me_Paymentmean_CreditcardResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
