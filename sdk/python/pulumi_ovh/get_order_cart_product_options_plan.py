...
__all__ = [
    ...
    'AwaitableGetOrderCartProductOptionsPlanResult',
    'get_order_cart_product_options_plan',
    'get_order_cart_product_options_plan_output',
]

@pulumi.output_type
class GetOrderCartProductOptionsPlanResult:
    """
    ...
    @property
    @pulumi.getter
    def prices(self) -> Sequence['outputs.GetOrderCartProductOptionsPlanPriceResult']:
    ...
    def selected_prices(self) -> Sequence['outputs.GetOrderCartProductOptionsPlanSelectedPriceResult']:
        return pulumi.get(self, "selected_prices")


class AwaitableGetOrderCartProductOptionsPlanResult(GetOrderCartProductOptionsPlanResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOrderCartProductOptionsPlanResult(
...
def get_order_cart_product_options_plan(cart_id: Optional[str] = None,
                                        catalog_name: Optional[str] = None,
                                        options_plan_code: Optional[str] = None,
                                        plan_code: Optional[str] = None,
                                        price_capacity: Optional[str] = None,
                                        product: Optional[str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOrderCartProductOptionsPlanResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ovh:index/getOrderCartProductOptionsPlan:getOrderCartProductOptionsPlan', __args__, opts=opts, typ=GetOrderCartProductOptionsPlanResult).value

    return AwaitableGetOrderCartProductOptionsPlanResult(
...
@_utilities.lift_output_func(get_order_cart_product_options_plan)
def get_order_cart_product_options_plan_output(cart_id: Optional[pulumi.Input[str]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOrderCartProductOptionsPlanResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
