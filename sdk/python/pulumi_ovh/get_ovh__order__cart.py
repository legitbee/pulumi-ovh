...
__all__ = [
    'GetOvh_Order_CartResult',
    'AwaitableGetOvh_Order_CartResult',
    'get_ovh__order__cart',
    'get_ovh__order__cart_output',
]

@pulumi.output_type
class GetOvh_Order_CartResult:
    """
...
class AwaitableGetOvh_Order_CartResult(GetOvh_Order_CartResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOvh_Order_CartResult(
...
def get_ovh__order__cart(description: Optional[str] = None,
                         expire: Optional[str] = None,
                         ovh_subsidiary: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOvh_Order_CartResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ovh:index/getOvh_Order_Cart:getOvh_Order_Cart', __args__, opts=opts, typ=GetOvh_Order_CartResult).value

    return AwaitableGetOvh_Order_CartResult(
...
@_utilities.lift_output_func(get_ovh__order__cart)
def get_ovh__order__cart_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                expire: Optional[pulumi.Input[Optional[str]]] = None,
                                ovh_subsidiary: Optional[pulumi.Input[str]] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOvh_Order_CartResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
