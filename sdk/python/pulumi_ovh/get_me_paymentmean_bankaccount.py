...
__all__ = [
    ...
    'get_me_paymentmean_bankaccount',
    'get_me_paymentmean_bankaccount_output',
]
...
def get_me_paymentmean_bankaccount(description_regexp: Optional[str] = None,
...
@_utilities.lift_output_func(get_me_paymentmean_bankaccount)
def get_me_paymentmean_bankaccount_output(description_regexp: Optional[pulumi.Input[Optional[str]]] = None,
