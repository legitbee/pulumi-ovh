...
__all__ = [
    'GetOvh_IploadbalancingResult',
    'AwaitableGetOvh_IploadbalancingResult',
    'get_ovh__iploadbalancing',
    'get_ovh__iploadbalancing_output',
]

@pulumi.output_type
class GetOvh_IploadbalancingResult:
    """
    ...
    def orderable_zones(self) -> Sequence['outputs.GetOvh_IploadbalancingOrderableZoneResult']:
...
class AwaitableGetOvh_IploadbalancingResult(GetOvh_IploadbalancingResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOvh_IploadbalancingResult(
...
def get_ovh__iploadbalancing(display_name: Optional[str] = None,
                             ...
                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOvh_IploadbalancingResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ovh:index/getOvh_Iploadbalancing:getOvh_Iploadbalancing', __args__, opts=opts, typ=GetOvh_IploadbalancingResult).value

    return AwaitableGetOvh_IploadbalancingResult(
...
@_utilities.lift_output_func(get_ovh__iploadbalancing)
def get_ovh__iploadbalancing_output(display_name: Optional[pulumi.Input[Optional[str]]] = None,
                                    ...
                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOvh_IploadbalancingResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
