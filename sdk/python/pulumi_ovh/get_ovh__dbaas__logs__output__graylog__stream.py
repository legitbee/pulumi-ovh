...
__all__ = [
    'GetOvh_Dbaas_Logs_Output_Graylog_StreamResult',
    'AwaitableGetOvh_Dbaas_Logs_Output_Graylog_StreamResult',
    'get_ovh__dbaas__logs__output__graylog__stream',
    'get_ovh__dbaas__logs__output__graylog__stream_output',
]

@pulumi.output_type
class GetOvh_Dbaas_Logs_Output_Graylog_StreamResult:
    """
...
class AwaitableGetOvh_Dbaas_Logs_Output_Graylog_StreamResult(GetOvh_Dbaas_Logs_Output_Graylog_StreamResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOvh_Dbaas_Logs_Output_Graylog_StreamResult(
...
def get_ovh__dbaas__logs__output__graylog__stream(service_name: Optional[str] = None,
                                                  title: Optional[str] = None,
                                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOvh_Dbaas_Logs_Output_Graylog_StreamResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ovh:index/getOvh_Dbaas_Logs_Output_Graylog_Stream:getOvh_Dbaas_Logs_Output_Graylog_Stream', __args__, opts=opts, typ=GetOvh_Dbaas_Logs_Output_Graylog_StreamResult).value

    return AwaitableGetOvh_Dbaas_Logs_Output_Graylog_StreamResult(
        can_alert=__ret__.can_alert,
        cold_storage_compression=__ret__.cold_storage_compression,
        cold_storage_content=__ret__.cold_storage_content,
        cold_storage_enabled=__ret__.cold_storage_enabled,
        cold_storage_notify_enabled=__ret__.cold_storage_notify_enabled,
        cold_storage_retention=__ret__.cold_storage_retention,
        cold_storage_target=__ret__.cold_storage_target,
        created_at=__ret__.created_at,
        description=__ret__.description,
        id=__ret__.id,
        indexing_enabled=__ret__.indexing_enabled,
        indexing_max_size=__ret__.indexing_max_size,
        indexing_notify_enabled=__ret__.indexing_notify_enabled,
        is_editable=__ret__.is_editable,
        is_shareable=__ret__.is_shareable,
        nb_alert_condition=__ret__.nb_alert_condition,
        nb_archive=__ret__.nb_archive,
        parent_stream_id=__ret__.parent_stream_id,
        pause_indexing_on_max_size=__ret__.pause_indexing_on_max_size,
        retention_id=__ret__.retention_id,
        service_name=__ret__.service_name,
        stream_id=__ret__.stream_id,
        title=__ret__.title,
        updated_at=__ret__.updated_at,
        web_socket_enabled=__ret__.web_socket_enabled)


@_utilities.lift_output_func(get_ovh__dbaas__logs__output__graylog__stream)
def get_ovh__dbaas__logs__output__graylog__stream_output(service_name: Optional[pulumi.Input[str]] = None,
                                                         title: Optional[pulumi.Input[str]] = None,
                                                         opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOvh_Dbaas_Logs_Output_Graylog_StreamResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
