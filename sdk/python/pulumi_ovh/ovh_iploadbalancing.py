...
__all__ = ['Ovh_iploadbalancingArgs', 'Ovh_iploadbalancing']

@pulumi.input_type
class Ovh_iploadbalancingArgs:
    def __init__(__self__, *,
                 ovh_subsidiary: pulumi.Input[str],
                 payment_mean: pulumi.Input[str],
                 plan: pulumi.Input['Ovh_iploadbalancingPlanArgs'],
                 display_name: Optional[pulumi.Input[str]] = None,
                 plan_options: Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_iploadbalancingPlanOptionArgs']]]] = None,
        ...
        :param pulumi.Input['Ovh_iploadbalancingPlanArgs'] plan: Product Plan to order
        :param pulumi.Input[str] display_name: Set the name displayed in ManagerV6 for your iplb (max 50 chars)
        :param pulumi.Input[Sequence[pulumi.Input['Ovh_iploadbalancingPlanOptionArgs']]] plan_options: Product Plan to order
    ...
    @property
    @pulumi.getter
    def plan(self) -> pulumi.Input['Ovh_iploadbalancingPlanArgs']:
        """
    ...
    @plan.setter
    def plan(self, value: pulumi.Input['Ovh_iploadbalancingPlanArgs']):
    ...
    def plan_options(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_iploadbalancingPlanOptionArgs']]]]:
        """
        Product Plan to order
        """
    ...
    @plan_options.setter
    def plan_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_iploadbalancingPlanOptionArgs']]]]):
...
@pulumi.input_type
class _Ovh_iploadbalancingState:
    def __init__(__self__, *,
                 display_name: Optional[pulumi.Input[str]] = None,
                 ...
                 orderable_zones: Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_iploadbalancingOrderableZoneArgs']]]] = None,
                 orders: Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_iploadbalancingOrderArgs']]]] = None,
                 ovh_subsidiary: Optional[pulumi.Input[str]] = None,
                 payment_mean: Optional[pulumi.Input[str]] = None,
                 plan: Optional[pulumi.Input['Ovh_iploadbalancingPlanArgs']] = None,
                 plan_options: Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_iploadbalancingPlanOptionArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['Ovh_iploadbalancingOrderableZoneArgs']]] orderable_zones: Available additional zone for your Load Balancer
        :param pulumi.Input[Sequence[pulumi.Input['Ovh_iploadbalancingOrderArgs']]] orders: Details about an Order
        :param pulumi.Input[str] ovh_subsidiary: Ovh Subsidiary
        :param pulumi.Input[str] payment_mean: Ovh payment mode
        :param pulumi.Input['Ovh_iploadbalancingPlanArgs'] plan: Product Plan to order
        :param pulumi.Input[Sequence[pulumi.Input['Ovh_iploadbalancingPlanOptionArgs']]] plan_options: Product Plan to order
    ...
    def orderable_zones(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_iploadbalancingOrderableZoneArgs']]]]:
        """
    ...
    def orderable_zones(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_iploadbalancingOrderableZoneArgs']]]]):
        pulumi.set(self, "orderable_zones", value)

    @property
    @pulumi.getter
    def orders(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_iploadbalancingOrderArgs']]]]:
        """
    ...
    @orders.setter
    def orders(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_iploadbalancingOrderArgs']]]]):
    ...
    @property
    @pulumi.getter
    def plan(self) -> Optional[pulumi.Input['Ovh_iploadbalancingPlanArgs']]:
        """
        Product Plan to order
        """
        return pulumi.get(self, "plan")
    ...
    @plan.setter
    def plan(self, value: Optional[pulumi.Input['Ovh_iploadbalancingPlanArgs']]):
        pulumi.set(self, "plan", value)
...
class Ovh_iploadbalancing(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 ovh_subsidiary: Optional[pulumi.Input[str]] = None,
                 payment_mean: Optional[pulumi.Input[str]] = None,
                 plan: Optional[pulumi.Input[pulumi.InputType['Ovh_iploadbalancingPlanArgs']]] = None,
                 plan_options: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ovh_iploadbalancingPlanOptionArgs']]]]] = None,
                 ssl_configuration: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        Create a Ovh_iploadbalancing resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] display_name: Set the name displayed in ManagerV6 for your iplb (max 50 chars)
        :param pulumi.Input[str] ovh_subsidiary: Ovh Subsidiary
        :param pulumi.Input[str] payment_mean: Ovh payment mode
        :param pulumi.Input[pulumi.InputType['Ovh_iploadbalancingPlanArgs']] plan: Product Plan to order
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ovh_iploadbalancingPlanOptionArgs']]]] plan_options: Product Plan to order
        :param pulumi.Input[str] ssl_configuration: Modern oldest compatible clients : Firefox 27, Chrome 30, IE 11 on Windows 7, Edge, Opera 17, Safari 9, Android 5.0, and
               Java 8. Intermediate oldest compatible clients : Firefox 1, Chrome 1, IE 7, Opera 5, Safari 1, Windows XP IE8, Android
               2.3, Java 7. Intermediate if null.
        """
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Ovh_iploadbalancingArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a Ovh_iploadbalancing resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param Ovh_iploadbalancingArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Ovh_iploadbalancingArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = Ovh_iploadbalancingArgs.__new__(Ovh_iploadbalancingArgs)
        ...
        super(Ovh_iploadbalancing, __self__).__init__(
            'ovh:index/ovh_iploadbalancing:ovh_iploadbalancing',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            metrics_token: Optional[pulumi.Input[str]] = None,
            offer: Optional[pulumi.Input[str]] = None,
            orderable_zones: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ovh_iploadbalancingOrderableZoneArgs']]]]] = None,
            orders: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ovh_iploadbalancingOrderArgs']]]]] = None,
            ovh_subsidiary: Optional[pulumi.Input[str]] = None,
            payment_mean: Optional[pulumi.Input[str]] = None,
            plan: Optional[pulumi.Input[pulumi.InputType['Ovh_iploadbalancingPlanArgs']]] = None,
            plan_options: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ovh_iploadbalancingPlanOptionArgs']]]]] = None,
            ...
            vrack_eligibility: Optional[pulumi.Input[bool]] = None,
            vrack_name: Optional[pulumi.Input[str]] = None,
            zones: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'Ovh_iploadbalancing':
        """
        ...
        :param pulumi.Input[str] metrics_token: The metrics token associated with your IP load balancing
        :param pulumi.Input[str] offer: The offer of your IP load balancing
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ovh_iploadbalancingOrderableZoneArgs']]]] orderable_zones: Available additional zone for your Load Balancer
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ovh_iploadbalancingOrderArgs']]]] orders: Details about an Order
        :param pulumi.Input[str] ovh_subsidiary: Ovh Subsidiary
        :param pulumi.Input[str] payment_mean: Ovh payment mode
        :param pulumi.Input[pulumi.InputType['Ovh_iploadbalancingPlanArgs']] plan: Product Plan to order
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ovh_iploadbalancingPlanOptionArgs']]]] plan_options: Product Plan to order
        ...
        __props__ = _Ovh_iploadbalancingState.__new__(_Ovh_iploadbalancingState)
        ...
        return Ovh_iploadbalancing(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="orderableZones")
    def orderable_zones(self) -> pulumi.Output[Sequence['outputs.Ovh_iploadbalancingOrderableZone']]:
        """
        Available additional zone for your Load Balancer
        """
        return pulumi.get(self, "orderable_zones")
    ...
    @property
    @pulumi.getter
    def orders(self) -> pulumi.Output[Sequence['outputs.Ovh_iploadbalancingOrder']]:
        """
        Details about an Order
        """
        return pulumi.get(self, "orders")
    ...
    @property
    @pulumi.getter
    def plan(self) -> pulumi.Output['outputs.Ovh_iploadbalancingPlan']:
        """
        Product Plan to order
        """
        return pulumi.get(self, "plan")
    ...
    @property
    @pulumi.getter(name="planOptions")
    def plan_options(self) -> pulumi.Output[Optional[Sequence['outputs.Ovh_iploadbalancingPlanOption']]]:
        """
        Product Plan to order
        """
        return pulumi.get(self, "plan_options")
