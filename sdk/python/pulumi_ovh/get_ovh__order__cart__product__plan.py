...
__all__ = [
    'GetOvh_Order_Cart_Product_PlanResult',
    'AwaitableGetOvh_Order_Cart_Product_PlanResult',
    'get_ovh__order__cart__product__plan',
    'get_ovh__order__cart__product__plan_output',
]

@pulumi.output_type
class GetOvh_Order_Cart_Product_PlanResult:
    """
    ...
    @property
    @pulumi.getter
    def prices(self) -> Sequence['outputs.GetOvh_Order_Cart_Product_PlanPriceResult']:
    ...
    def selected_prices(self) -> Sequence['outputs.GetOvh_Order_Cart_Product_PlanSelectedPriceResult']:
        return pulumi.get(self, "selected_prices")


class AwaitableGetOvh_Order_Cart_Product_PlanResult(GetOvh_Order_Cart_Product_PlanResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOvh_Order_Cart_Product_PlanResult(
...
def get_ovh__order__cart__product__plan(cart_id: Optional[str] = None,
                                        catalog_name: Optional[str] = None,
                                        plan_code: Optional[str] = None,
                                        price_capacity: Optional[str] = None,
                                        product: Optional[str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOvh_Order_Cart_Product_PlanResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ovh:index/getOvh_Order_Cart_Product_Plan:getOvh_Order_Cart_Product_Plan', __args__, opts=opts, typ=GetOvh_Order_Cart_Product_PlanResult).value

    return AwaitableGetOvh_Order_Cart_Product_PlanResult(
...
@_utilities.lift_output_func(get_ovh__order__cart__product__plan)
def get_ovh__order__cart__product__plan_output(cart_id: Optional[pulumi.Input[str]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOvh_Order_Cart_Product_PlanResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
