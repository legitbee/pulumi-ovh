...
__all__ = [
    ...
    'get_iploadbalancing_vrack_network',
    'get_iploadbalancing_vrack_network_output',
]
...
def get_iploadbalancing_vrack_network(service_name: Optional[str] = None,
...
@_utilities.lift_output_func(get_iploadbalancing_vrack_network)
def get_iploadbalancing_vrack_network_output(service_name: Optional[pulumi.Input[str]] = None,
