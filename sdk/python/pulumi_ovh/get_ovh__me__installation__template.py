...
__all__ = [
    'GetOvh_Me_Installation_TemplateResult',
    'AwaitableGetOvh_Me_Installation_TemplateResult',
    'get_ovh__me__installation__template',
    'get_ovh__me__installation__template_output',
]

@pulumi.output_type
class GetOvh_Me_Installation_TemplateResult:
    """
    ...
    @property
    @pulumi.getter
    def customizations(self) -> Sequence['outputs.GetOvh_Me_Installation_TemplateCustomizationResult']:
    ...
    def partition_schemes(self) -> Sequence['outputs.GetOvh_Me_Installation_TemplatePartitionSchemeResult']:
...
class AwaitableGetOvh_Me_Installation_TemplateResult(GetOvh_Me_Installation_TemplateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOvh_Me_Installation_TemplateResult(
...
def get_ovh__me__installation__template(template_name: Optional[str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOvh_Me_Installation_TemplateResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ovh:index/getOvh_Me_Installation_Template:getOvh_Me_Installation_Template', __args__, opts=opts, typ=GetOvh_Me_Installation_TemplateResult).value

    return AwaitableGetOvh_Me_Installation_TemplateResult(
...
@_utilities.lift_output_func(get_ovh__me__installation__template)
def get_ovh__me__installation__template_output(template_name: Optional[pulumi.Input[str]] = None,
                                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOvh_Me_Installation_TemplateResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
