...
__all__ = [
    ...
    'AwaitableGetDbaasLogsOutputGraylogStreamResult',
    'get_dbaas_logs_output_graylog_stream',
    'get_dbaas_logs_output_graylog_stream_output',
]

@pulumi.output_type
class GetDbaasLogsOutputGraylogStreamResult:
    """
...
class AwaitableGetDbaasLogsOutputGraylogStreamResult(GetDbaasLogsOutputGraylogStreamResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDbaasLogsOutputGraylogStreamResult(
...
def get_dbaas_logs_output_graylog_stream(service_name: Optional[str] = None,
                                         ...
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDbaasLogsOutputGraylogStreamResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ovh:index/getDbaasLogsOutputGraylogStream:getDbaasLogsOutputGraylogStream', __args__, opts=opts, typ=GetDbaasLogsOutputGraylogStreamResult).value

    return AwaitableGetDbaasLogsOutputGraylogStreamResult(
...
@_utilities.lift_output_func(get_dbaas_logs_output_graylog_stream)
def get_dbaas_logs_output_graylog_stream_output(service_name: Optional[pulumi.Input[str]] = None,
                                                title: Optional[pulumi.Input[str]] = None,
                                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDbaasLogsOutputGraylogStreamResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
