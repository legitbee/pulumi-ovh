...
__all__ = ['Ovh_dbaas_logs_output_graylog_streamArgs', 'Ovh_dbaas_logs_output_graylog_stream']

@pulumi.input_type
class Ovh_dbaas_logs_output_graylog_streamArgs:
...
@pulumi.input_type
class _Ovh_dbaas_logs_output_graylog_streamState:
    def __init__(__self__, *,
...
class Ovh_dbaas_logs_output_graylog_stream(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a Ovh_dbaas_logs_output_graylog_stream resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Ovh_dbaas_logs_output_graylog_streamArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a Ovh_dbaas_logs_output_graylog_stream resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param Ovh_dbaas_logs_output_graylog_streamArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Ovh_dbaas_logs_output_graylog_streamArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = Ovh_dbaas_logs_output_graylog_streamArgs.__new__(Ovh_dbaas_logs_output_graylog_streamArgs)
        ...
        super(Ovh_dbaas_logs_output_graylog_stream, __self__).__init__(
            'ovh:index/ovh_dbaas_logs_output_graylog_stream:ovh_dbaas_logs_output_graylog_stream',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            title: Optional[pulumi.Input[str]] = None,
            updated_at: Optional[pulumi.Input[str]] = None,
            web_socket_enabled: Optional[pulumi.Input[bool]] = None) -> 'Ovh_dbaas_logs_output_graylog_stream':
        """
        ...
        __props__ = _Ovh_dbaas_logs_output_graylog_streamState.__new__(_Ovh_dbaas_logs_output_graylog_streamState)
        ...
        __props__.__dict__["web_socket_enabled"] = web_socket_enabled
        return Ovh_dbaas_logs_output_graylog_stream(resource_name, opts=opts, __props__=__props__)
