...
__all__ = ['Ovh_domain_zoneArgs', 'Ovh_domain_zone']

@pulumi.input_type
class Ovh_domain_zoneArgs:
    def __init__(__self__, *,
                 ovh_subsidiary: pulumi.Input[str],
                 payment_mean: pulumi.Input[str],
                 plan: pulumi.Input['Ovh_domain_zonePlanArgs'],
                 plan_options: Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_domain_zonePlanOptionArgs']]]] = None):
        """
        ...
        :param pulumi.Input['Ovh_domain_zonePlanArgs'] plan: Product Plan to order
        :param pulumi.Input[Sequence[pulumi.Input['Ovh_domain_zonePlanOptionArgs']]] plan_options: Product Plan to order
        """
    ...
    @property
    @pulumi.getter
    def plan(self) -> pulumi.Input['Ovh_domain_zonePlanArgs']:
        """
    ...
    @plan.setter
    def plan(self, value: pulumi.Input['Ovh_domain_zonePlanArgs']):
        pulumi.set(self, "plan", value)

    @property
    @pulumi.getter(name="planOptions")
    def plan_options(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_domain_zonePlanOptionArgs']]]]:
        """
        Product Plan to order
        """
    ...
    @plan_options.setter
    def plan_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_domain_zonePlanOptionArgs']]]]):
        pulumi.set(self, "plan_options", value)


@pulumi.input_type
class _Ovh_domain_zoneState:
    def __init__(__self__, *,
                 ...
                 orders: Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_domain_zoneOrderArgs']]]] = None,
                 ovh_subsidiary: Optional[pulumi.Input[str]] = None,
                 payment_mean: Optional[pulumi.Input[str]] = None,
                 plan: Optional[pulumi.Input['Ovh_domain_zonePlanArgs']] = None,
                 plan_options: Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_domain_zonePlanOptionArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['Ovh_domain_zoneOrderArgs']]] orders: Details about an Order
        :param pulumi.Input[str] ovh_subsidiary: Ovh Subsidiary
        :param pulumi.Input[str] payment_mean: Ovh payment mode
        :param pulumi.Input['Ovh_domain_zonePlanArgs'] plan: Product Plan to order
        :param pulumi.Input[Sequence[pulumi.Input['Ovh_domain_zonePlanOptionArgs']]] plan_options: Product Plan to order
    ...
    @property
    @pulumi.getter
    def orders(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_domain_zoneOrderArgs']]]]:
        """
    ...
    @orders.setter
    def orders(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['Ovh_domain_zoneOrderArgs']]]]):
    ...
    @property
    @pulumi.getter
    def plan(self) -> Optional[pulumi.Input['Ovh_domain_zonePlanArgs']]:
        """
        Product Plan to order
        """
        return pulumi.get(self, "plan")
    ...
    @plan.setter
    def plan(self, value: Optional[pulumi.Input['Ovh_domain_zonePlanArgs']]):
        pulumi.set(self, "plan", value)
...
class Ovh_domain_zone(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 ovh_subsidiary: Optional[pulumi.Input[str]] = None,
                 payment_mean: Optional[pulumi.Input[str]] = None,
                 plan: Optional[pulumi.Input[pulumi.InputType['Ovh_domain_zonePlanArgs']]] = None,
                 plan_options: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ovh_domain_zonePlanOptionArgs']]]]] = None,
                 __props__=None):
        """
        Create a Ovh_domain_zone resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[str] ovh_subsidiary: Ovh Subsidiary
        :param pulumi.Input[str] payment_mean: Ovh payment mode
        :param pulumi.Input[pulumi.InputType['Ovh_domain_zonePlanArgs']] plan: Product Plan to order
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ovh_domain_zonePlanOptionArgs']]]] plan_options: Product Plan to order
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: Ovh_domain_zoneArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a Ovh_domain_zone resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param Ovh_domain_zoneArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Ovh_domain_zoneArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = Ovh_domain_zoneArgs.__new__(Ovh_domain_zoneArgs)
        ...
        super(Ovh_domain_zone, __self__).__init__(
            'ovh:index/ovh_domain_zone:ovh_domain_zone',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            name_servers: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            orders: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ovh_domain_zoneOrderArgs']]]]] = None,
            ovh_subsidiary: Optional[pulumi.Input[str]] = None,
            payment_mean: Optional[pulumi.Input[str]] = None,
            plan: Optional[pulumi.Input[pulumi.InputType['Ovh_domain_zonePlanArgs']]] = None,
            plan_options: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ovh_domain_zonePlanOptionArgs']]]]] = None) -> 'Ovh_domain_zone':
        """
        ...
        :param pulumi.Input[str] name: Zone name
        :param pulumi.Input[Sequence[pulumi.Input[str]]] name_servers: Name servers that host the DNS zone
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ovh_domain_zoneOrderArgs']]]] orders: Details about an Order
        :param pulumi.Input[str] ovh_subsidiary: Ovh Subsidiary
        :param pulumi.Input[str] payment_mean: Ovh payment mode
        :param pulumi.Input[pulumi.InputType['Ovh_domain_zonePlanArgs']] plan: Product Plan to order
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['Ovh_domain_zonePlanOptionArgs']]]] plan_options: Product Plan to order
        ...
        __props__ = _Ovh_domain_zoneState.__new__(_Ovh_domain_zoneState)
        ...
        __props__.__dict__["plan"] = plan
        __props__.__dict__["plan_options"] = plan_options
        return Ovh_domain_zone(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def orders(self) -> pulumi.Output[Sequence['outputs.Ovh_domain_zoneOrder']]:
        """
        Details about an Order
        """
        return pulumi.get(self, "orders")
    ...
    @property
    @pulumi.getter
    def plan(self) -> pulumi.Output['outputs.Ovh_domain_zonePlan']:
        """
        Product Plan to order
        """
        return pulumi.get(self, "plan")
    ...
    @property
    @pulumi.getter(name="planOptions")
    def plan_options(self) -> pulumi.Output[Optional[Sequence['outputs.Ovh_domain_zonePlanOption']]]:
        """
        Product Plan to order
        """
        return pulumi.get(self, "plan_options")
