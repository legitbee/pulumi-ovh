...
__all__ = ['MeInstallationTemplateArgs', 'MeInstallationTemplate']

@pulumi.input_type
class MeInstallationTemplateArgs:
    def __init__(__self__, *,
                 base_template_name: pulumi.Input[str],
                 default_language: pulumi.Input[str],
                 template_name: pulumi.Input[str],
                 customization: Optional[pulumi.Input['MeInstallationTemplateCustomizationArgs']] = None,
    ...
    @property
    @pulumi.getter
    def customization(self) -> Optional[pulumi.Input['MeInstallationTemplateCustomizationArgs']]:
        return pulumi.get(self, "customization")

    @customization.setter
    def customization(self, value: Optional[pulumi.Input['MeInstallationTemplateCustomizationArgs']]):
...
@pulumi.input_type
class _MeInstallationTemplateState:
    def __init__(__self__, *,
...
class MeInstallationTemplate(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 base_template_name: Optional[pulumi.Input[str]] = None,
                 customization: Optional[pulumi.Input[pulumi.InputType['MeInstallationTemplateCustomizationArgs']]] = None,
                 default_language: Optional[pulumi.Input[str]] = None,
                 remove_default_partition_schemes: Optional[pulumi.Input[bool]] = None,
                 template_name: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        Create a MeInstallationTemplate resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: MeInstallationTemplateArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a MeInstallationTemplate resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param MeInstallationTemplateArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MeInstallationTemplateArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MeInstallationTemplateArgs.__new__(MeInstallationTemplateArgs)
        ...
        super(MeInstallationTemplate, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            supports_sql_server: Optional[pulumi.Input[bool]] = None,
            supports_uefi: Optional[pulumi.Input[str]] = None,
            template_name: Optional[pulumi.Input[str]] = None) -> 'MeInstallationTemplate':
        """
        ...
        __props__ = _MeInstallationTemplateState.__new__(_MeInstallationTemplateState)
        ...
        __props__.__dict__["template_name"] = template_name
        return MeInstallationTemplate(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def customization(self) -> pulumi.Output[Optional['outputs.MeInstallationTemplateCustomization']]:
        return pulumi.get(self, "customization")
