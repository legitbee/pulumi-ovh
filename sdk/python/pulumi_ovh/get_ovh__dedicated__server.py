...
__all__ = [
    'GetOvh_Dedicated_ServerResult',
    'AwaitableGetOvh_Dedicated_ServerResult',
    'get_ovh__dedicated__server',
    'get_ovh__dedicated__server_output',
]

@pulumi.output_type
class GetOvh_Dedicated_ServerResult:
    """
    ...
    @property
    @pulumi.getter
    def vnis(self) -> Sequence['outputs.GetOvh_Dedicated_ServerVniResult']:
        return pulumi.get(self, "vnis")


class AwaitableGetOvh_Dedicated_ServerResult(GetOvh_Dedicated_ServerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOvh_Dedicated_ServerResult(
...
def get_ovh__dedicated__server(service_name: Optional[str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOvh_Dedicated_ServerResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ovh:index/getOvh_Dedicated_Server:getOvh_Dedicated_Server', __args__, opts=opts, typ=GetOvh_Dedicated_ServerResult).value

    return AwaitableGetOvh_Dedicated_ServerResult(
...
@_utilities.lift_output_func(get_ovh__dedicated__server)
def get_ovh__dedicated__server_output(service_name: Optional[pulumi.Input[str]] = None,
                                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOvh_Dedicated_ServerResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
