...
__all__ = [
    'GetOvh_Me_Identity_UserResult',
    'AwaitableGetOvh_Me_Identity_UserResult',
    'get_ovh__me__identity__user',
    'get_ovh__me__identity__user_output',
]

@pulumi.output_type
class GetOvh_Me_Identity_UserResult:
    """
...
class AwaitableGetOvh_Me_Identity_UserResult(GetOvh_Me_Identity_UserResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOvh_Me_Identity_UserResult(
...
def get_ovh__me__identity__user(user: Optional[str] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOvh_Me_Identity_UserResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('ovh:index/getOvh_Me_Identity_User:getOvh_Me_Identity_User', __args__, opts=opts, typ=GetOvh_Me_Identity_UserResult).value

    return AwaitableGetOvh_Me_Identity_UserResult(
...
@_utilities.lift_output_func(get_ovh__me__identity__user)
def get_ovh__me__identity__user_output(user: Optional[pulumi.Input[str]] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOvh_Me_Identity_UserResult]:
    """
    Use this data source to access information about an existing resource.
    """
    ...
