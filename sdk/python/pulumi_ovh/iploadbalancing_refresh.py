...
__all__ = ['IploadbalancingRefreshArgs', 'IploadbalancingRefresh']

@pulumi.input_type
class IploadbalancingRefreshArgs:
...
@pulumi.input_type
class _IploadbalancingRefreshState:
    def __init__(__self__, *,
...
class IploadbalancingRefresh(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a IploadbalancingRefresh resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: IploadbalancingRefreshArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a IploadbalancingRefresh resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param IploadbalancingRefreshArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IploadbalancingRefreshArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = IploadbalancingRefreshArgs.__new__(IploadbalancingRefreshArgs)
        ...
        super(IploadbalancingRefresh, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            keepers: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            service_name: Optional[pulumi.Input[str]] = None) -> 'IploadbalancingRefresh':
        """
        ...
        __props__ = _IploadbalancingRefreshState.__new__(_IploadbalancingRefreshState)

        __props__.__dict__["keepers"] = keepers
        __props__.__dict__["service_name"] = service_name
        return IploadbalancingRefresh(resource_name, opts=opts, __props__=__props__)
