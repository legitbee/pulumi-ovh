...
__all__ = ['Ovh_vrack_ipArgs', 'Ovh_vrack_ip']

@pulumi.input_type
class Ovh_vrack_ipArgs:
...
class Ovh_vrack_ip(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a Ovh_vrack_ip resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Ovh_vrack_ipArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a Ovh_vrack_ip resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param Ovh_vrack_ipArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(Ovh_vrack_ipArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = Ovh_vrack_ipArgs.__new__(Ovh_vrack_ipArgs)
        ...
        super(Ovh_vrack_ip, __self__).__init__(
            'ovh:index/ovh_vrack_ip:ovh_vrack_ip',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            ip: Optional[pulumi.Input[str]] = None,
            service_name: Optional[pulumi.Input[str]] = None,
            zone: Optional[pulumi.Input[str]] = None) -> 'Ovh_vrack_ip':
        """
        ...
        __props__ = _Ovh_vrack_ipState.__new__(_Ovh_vrack_ipState)
        ...
        return Ovh_vrack_ip(resource_name, opts=opts, __props__=__props__)
