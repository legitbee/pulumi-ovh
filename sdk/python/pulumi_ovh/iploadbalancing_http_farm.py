...
__all__ = ['IploadbalancingHttpFarmArgs', 'IploadbalancingHttpFarm']

@pulumi.input_type
class IploadbalancingHttpFarmArgs:
    def __init__(__self__, *,
                 ...
                 probe: Optional[pulumi.Input['IploadbalancingHttpFarmProbeArgs']] = None,
    ...
    @property
    @pulumi.getter
    def probe(self) -> Optional[pulumi.Input['IploadbalancingHttpFarmProbeArgs']]:
        return pulumi.get(self, "probe")

    @probe.setter
    def probe(self, value: Optional[pulumi.Input['IploadbalancingHttpFarmProbeArgs']]):
...
@pulumi.input_type
class _IploadbalancingHttpFarmState:
    def __init__(__self__, *,
                 balance: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 port: Optional[pulumi.Input[int]] = None,
...
class IploadbalancingHttpFarm(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 display_name: Optional[pulumi.Input[str]] = None,
                 port: Optional[pulumi.Input[int]] = None,
                 probe: Optional[pulumi.Input[pulumi.InputType['IploadbalancingHttpFarmProbeArgs']]] = None,
                 service_name: Optional[pulumi.Input[str]] = None,
                 stickiness: Optional[pulumi.Input[str]] = None,
                 vrack_network_id: Optional[pulumi.Input[int]] = None,
                 zone: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        Create a IploadbalancingHttpFarm resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: IploadbalancingHttpFarmArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a IploadbalancingHttpFarm resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param IploadbalancingHttpFarmArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(IploadbalancingHttpFarmArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = IploadbalancingHttpFarmArgs.__new__(IploadbalancingHttpFarmArgs)
        ...
        super(IploadbalancingHttpFarm, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            stickiness: Optional[pulumi.Input[str]] = None,
            vrack_network_id: Optional[pulumi.Input[int]] = None,
            zone: Optional[pulumi.Input[str]] = None) -> 'IploadbalancingHttpFarm':
        """
        ...
        __props__ = _IploadbalancingHttpFarmState.__new__(_IploadbalancingHttpFarmState)
        ...
        __props__.__dict__["vrack_network_id"] = vrack_network_id
        __props__.__dict__["zone"] = zone
        return IploadbalancingHttpFarm(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def probe(self) -> pulumi.Output[Optional['outputs.IploadbalancingHttpFarmProbe']]:
        return pulumi.get(self, "probe")
