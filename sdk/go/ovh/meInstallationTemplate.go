...
func (*MeInstallationTemplate) ElementType() reflect.Type {
	return reflect.TypeOf((*MeInstallationTemplate)(nil))
}
...
func (i *MeInstallationTemplate) ToMeInstallationTemplatePtrOutput() MeInstallationTemplatePtrOutput {
	return i.ToMeInstallationTemplatePtrOutputWithContext(context.Background())
}

func (i *MeInstallationTemplate) ToMeInstallationTemplatePtrOutputWithContext(ctx context.Context) MeInstallationTemplatePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(MeInstallationTemplatePtrOutput)
}

type MeInstallationTemplatePtrInput interface {
	pulumi.Input

	ToMeInstallationTemplatePtrOutput() MeInstallationTemplatePtrOutput
	ToMeInstallationTemplatePtrOutputWithContext(ctx context.Context) MeInstallationTemplatePtrOutput
}

type meInstallationTemplatePtrType MeInstallationTemplateArgs

func (*meInstallationTemplatePtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**MeInstallationTemplate)(nil))
}

func (i *meInstallationTemplatePtrType) ToMeInstallationTemplatePtrOutput() MeInstallationTemplatePtrOutput {
	return i.ToMeInstallationTemplatePtrOutputWithContext(context.Background())
}

func (i *meInstallationTemplatePtrType) ToMeInstallationTemplatePtrOutputWithContext(ctx context.Context) MeInstallationTemplatePtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(MeInstallationTemplatePtrOutput)
}
...
func (o MeInstallationTemplateOutput) ToMeInstallationTemplatePtrOutput() MeInstallationTemplatePtrOutput {
	return o.ToMeInstallationTemplatePtrOutputWithContext(context.Background())
}

func (o MeInstallationTemplateOutput) ToMeInstallationTemplatePtrOutputWithContext(ctx context.Context) MeInstallationTemplatePtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v MeInstallationTemplate) *MeInstallationTemplate {
		return &v
	}).(MeInstallationTemplatePtrOutput)
}

type MeInstallationTemplatePtrOutput struct{ *pulumi.OutputState }

func (MeInstallationTemplatePtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**MeInstallationTemplate)(nil))
}

func (o MeInstallationTemplatePtrOutput) ToMeInstallationTemplatePtrOutput() MeInstallationTemplatePtrOutput {
	return o
}

func (o MeInstallationTemplatePtrOutput) ToMeInstallationTemplatePtrOutputWithContext(ctx context.Context) MeInstallationTemplatePtrOutput {
	return o
}

func (o MeInstallationTemplatePtrOutput) Elem() MeInstallationTemplateOutput {
	return o.ApplyT(func(v *MeInstallationTemplate) MeInstallationTemplate {
		if v != nil {
			return *v
		}
		var ret MeInstallationTemplate
		return ret
...
func (MeInstallationTemplateMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]MeInstallationTemplate)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(MeInstallationTemplatePtrOutput{})
