...
func (*DbaasLogsOutputGraylogStream) ElementType() reflect.Type {
	return reflect.TypeOf((*DbaasLogsOutputGraylogStream)(nil))
}
...
func (i *DbaasLogsOutputGraylogStream) ToDbaasLogsOutputGraylogStreamPtrOutput() DbaasLogsOutputGraylogStreamPtrOutput {
	return i.ToDbaasLogsOutputGraylogStreamPtrOutputWithContext(context.Background())
}

func (i *DbaasLogsOutputGraylogStream) ToDbaasLogsOutputGraylogStreamPtrOutputWithContext(ctx context.Context) DbaasLogsOutputGraylogStreamPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DbaasLogsOutputGraylogStreamPtrOutput)
}

type DbaasLogsOutputGraylogStreamPtrInput interface {
	pulumi.Input

	ToDbaasLogsOutputGraylogStreamPtrOutput() DbaasLogsOutputGraylogStreamPtrOutput
	ToDbaasLogsOutputGraylogStreamPtrOutputWithContext(ctx context.Context) DbaasLogsOutputGraylogStreamPtrOutput
}

type dbaasLogsOutputGraylogStreamPtrType DbaasLogsOutputGraylogStreamArgs

func (*dbaasLogsOutputGraylogStreamPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**DbaasLogsOutputGraylogStream)(nil))
}

func (i *dbaasLogsOutputGraylogStreamPtrType) ToDbaasLogsOutputGraylogStreamPtrOutput() DbaasLogsOutputGraylogStreamPtrOutput {
	return i.ToDbaasLogsOutputGraylogStreamPtrOutputWithContext(context.Background())
}

func (i *dbaasLogsOutputGraylogStreamPtrType) ToDbaasLogsOutputGraylogStreamPtrOutputWithContext(ctx context.Context) DbaasLogsOutputGraylogStreamPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(DbaasLogsOutputGraylogStreamPtrOutput)
}
...
func (o DbaasLogsOutputGraylogStreamOutput) ToDbaasLogsOutputGraylogStreamPtrOutput() DbaasLogsOutputGraylogStreamPtrOutput {
	return o.ToDbaasLogsOutputGraylogStreamPtrOutputWithContext(context.Background())
}

func (o DbaasLogsOutputGraylogStreamOutput) ToDbaasLogsOutputGraylogStreamPtrOutputWithContext(ctx context.Context) DbaasLogsOutputGraylogStreamPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v DbaasLogsOutputGraylogStream) *DbaasLogsOutputGraylogStream {
		return &v
	}).(DbaasLogsOutputGraylogStreamPtrOutput)
}

type DbaasLogsOutputGraylogStreamPtrOutput struct{ *pulumi.OutputState }

func (DbaasLogsOutputGraylogStreamPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**DbaasLogsOutputGraylogStream)(nil))
}

func (o DbaasLogsOutputGraylogStreamPtrOutput) ToDbaasLogsOutputGraylogStreamPtrOutput() DbaasLogsOutputGraylogStreamPtrOutput {
	return o
}

func (o DbaasLogsOutputGraylogStreamPtrOutput) ToDbaasLogsOutputGraylogStreamPtrOutputWithContext(ctx context.Context) DbaasLogsOutputGraylogStreamPtrOutput {
	return o
}

func (o DbaasLogsOutputGraylogStreamPtrOutput) Elem() DbaasLogsOutputGraylogStreamOutput {
	return o.ApplyT(func(v *DbaasLogsOutputGraylogStream) DbaasLogsOutputGraylogStream {
		if v != nil {
			return *v
		}
		var ret DbaasLogsOutputGraylogStream
		return ret
...
func (DbaasLogsOutputGraylogStreamMapOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*map[string]DbaasLogsOutputGraylogStream)(nil))
}
...
func init() {
	...
	pulumi.RegisterOutputType(DbaasLogsOutputGraylogStreamPtrOutput{})
