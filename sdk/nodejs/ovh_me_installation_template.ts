...
export class Ovh_me_installation_template extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Ovh_me_installation_templateState, opts?: pulumi.CustomResourceOptions): Ovh_me_installation_template {
        return new Ovh_me_installation_template(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ovh:index/ovh_me_installation_template:ovh_me_installation_template';

    /**
     * Returns true if the given object is an instance of Ovh_me_installation_template.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Ovh_me_installation_template {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Ovh_me_installation_template.__pulumiType;
    }
    ...
    public readonly customization!: pulumi.Output<outputs.Ovh_me_installation_templateCustomization | undefined>;
    /**
     ...
     */
    constructor(name: string, args: Ovh_me_installation_templateArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: Ovh_me_installation_templateArgs | Ovh_me_installation_templateState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as Ovh_me_installation_templateState | undefined;
            ...
            const args = argsOrState as Ovh_me_installation_templateArgs | undefined;
        ...
        super(Ovh_me_installation_template.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface Ovh_me_installation_templateState {
    /**
     * List of all language available for this template
     */
    ...
    customization?: pulumi.Input<inputs.Ovh_me_installation_templateCustomization>;
    /**
     * The default language of this template
     */
 ...
 */
export interface Ovh_me_installation_templateArgs {
    /**
     * OVH template name yours will be based on, choose one among the list given by compatibleTemplates function
     */
    baseTemplateName: pulumi.Input<string>;
