...
export class DbaasLogsOutputGraylogStream extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DbaasLogsOutputGraylogStreamState, opts?: pulumi.CustomResourceOptions): DbaasLogsOutputGraylogStream {
        return new DbaasLogsOutputGraylogStream(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'ovh:index/dbaasLogsOutputGraylogStream:DbaasLogsOutputGraylogStream';

    /**
     * Returns true if the given object is an instance of DbaasLogsOutputGraylogStream.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DbaasLogsOutputGraylogStream {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DbaasLogsOutputGraylogStream.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: DbaasLogsOutputGraylogStreamArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DbaasLogsOutputGraylogStreamArgs | DbaasLogsOutputGraylogStreamState, opts?: pulumi.CustomResourceOptions) {
        let inputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DbaasLogsOutputGraylogStreamState | undefined;
            ...
            const args = argsOrState as DbaasLogsOutputGraylogStreamArgs | undefined;
        ...
        super(DbaasLogsOutputGraylogStream.__pulumiType, name, inputs, opts);
    }
}
 ...
 */
export interface DbaasLogsOutputGraylogStreamState {
    /**
     * Indicates if the current user can create alert on the stream
     */
 ...
 */
export interface DbaasLogsOutputGraylogStreamArgs {
    /**
     * Cold storage compression method
     */
    coldStorageCompression?: pulumi.Input<string>;
